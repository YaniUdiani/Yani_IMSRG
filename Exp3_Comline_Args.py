...
#MBPT(3) can be turned off, and BCH expansion terms can be 
#specified (default =3)
#------------------------------------------------------------------------------
...
def ph_transform_2B(x_map_o,y_map_o,occphA_2B, block_sizes,bas_block2B,
                    bas2B,bs_len,idp,subset2B,subset_size,
                    blocks_that_matter,blk_nums_that_matter,y_ph_zeros):
...
def main():
  ...
  bn2=Bernoulli_generator(trunc)# Go up to 3 terms in expansion
