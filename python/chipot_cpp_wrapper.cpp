...
double chipot_real_wrapper( int Nparticles, double rho,
  ...
  chipot_f90_wrapper( &matel_real, &matel_imag,
      Nparticles, rho,
      ps, pt, ppx, ppy, ppz,
      qs, qt, qpx, qpy, qpz,
      rs, rt, rpx, rpy, rpz,
...
// takes in just the single particle state indices, unpacks them into the raw quantum number
// data, and passes them to the fortran wrapper
complex<double> chipot_cpp_wrapper(SPBasis *basis, double density, int p, int q, int r, int s){
  ...
  chipot_f90_wrapper(&matel_real, &matel_im,
      Nparticles, rho,
      ps, pt, ppx, ppy, ppz,
      qs, qt, qpx, qpy, qpz,
      rs, rt, rpx, rpy, rpz,
