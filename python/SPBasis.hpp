...
class SPBasis{
	public:
		...
		virtual std::complex<double> calcTBME(std::size_t p, std::size_t q, std::size_t r, std::size_t s) = 0;

		// Non-antisymmetric TBMEs
		virtual std::complex<double> calc_TBME_not_antisym(std::size_t p, std::size_t q, std::size_t r, std::size_t s) = 0;
