...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 15 13:30:19 2020
...
#------------------------------------------------------------------------------
""" 
This version rewrites parts of J_Dev3 so that I can write my BCH and Magnus
series exclusively inside C when I port the code over to Cython. 
...
def construct_index_2B(bas2B):
  """Constructs Lookup for cython. I'll flatten my blocked operators
  using List_reshape, then pass them to Cython."""
...
def main():
  ...
  A = 2 #specify number of particles you want to include
  ...
  cython_lookup = construct_index_2B(bas2B)
  
  #print(bas2B[0:50])
  #print("----------")
  #print(bas_block2B[0:5])
